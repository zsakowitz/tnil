...
impl Gloss for Formative {
    fn gloss(&self, flags: GlossFlags) -> String {
        ...
        // T1-PRC.S1.‘[+head]’-“root”-STA.BSC.EXS-‘affix’-{Ca}-‘affix’-MNO.CCN-THM\UNF
        // __-XXX.XX._________-XXXXXX-___.___.___-XXXXXXX-XXXX-XXXXXXX-XXX.XXX-___\___
        ...
        let (shortcut_type, relation, ca, slot_v, function, specification, context) =
            match additions {
